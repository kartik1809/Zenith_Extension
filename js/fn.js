...
const dcl = (e) => {
  ...
  getDomainObj = () => ({ name: "", alltime: { seconds: 0 }, days: {} }),
  getDayObj = () => ({ seconds: 0 }),
  getTimeObj = () => ({
    day: { tens: 0, units: 0, implicitlyActive: !1, unit: TIME_UNIT_DAY },
    hour: { tens: 0, units: 0, implicitlyActive: !1, unit: TIME_UNIT_HOUR },
    minute: { tens: 0, units: 0, implicitlyActive: !1, unit: TIME_UNIT_MINUTE },
    second: { tens: 0, units: 0, implicitlyActive: !1, unit: TIME_UNIT_SECOND },
  }),
  getDateString = (e = null) => {
    let t, n, r, o, l;
    return (
  ...
  getIdleTimeRawFromComputed = (e) => {
    ...
    return (
      -1 === t &&
        ((t = IDLE_TIME_TABLE.indexOf(IDLE_TIME_DEFAULT)),
  ...
  getSliderComputedFromRaw = (e, t, n) => {
    let r = e[n];
    return (
      void 0 === r && ((r = t), console.error("Undefined raw value: " + n)), r
    );
  },
  ...
  convertArrayToCsv = (e, t, n) => {
    ...
    for (
      ...
      for (d += o[l], a = 0; a < s.length; a++)
        (i = e[o[l]].days[s[a]]), (d += "," + (i ? i.seconds : 0));
      d += "\n";
    }
    return d;
  },
